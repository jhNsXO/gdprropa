...
class RecipientsCategory extends CommonDropdown
{
    public static $rightname = 'plugin_gdprropa_recipientscategory';
    ...
    {
        $rel = new Record_RecipientsCategory();
        $rel->deleteByCriteria(['plugin_gdprropa_recipientscategories_id' => $this->fields['id']]);
    }
