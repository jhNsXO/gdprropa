...
class Purpose extends CommonDropdown
{
    public static $rightname = 'plugin_gdprropa_purpose';
    ...
    {
        $rel = new Record_Purpose();
        $rel->deleteByCriteria(['plugin_gdprropa_purposes_id' => $this->fields['id']]);
    }
