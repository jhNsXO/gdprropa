...
class Record_Purpose extends CommonDBRelation
{
    public static $itemtype_1 = Record::class;
    public static $items_id_1 = 'plugin_gdprropa_records_id';
    public static $itemtype_2 = Purpose::class;
    public static $items_id_2 = 'plugin_gdprropa_purposes_id';

    public static function getTypeName($nb = 0): string
    {
        return _n("Purpose", "Purposes", $nb, 'gdprropa');
    }
    ...
    public function getTabNameForItem(CommonGLPI $item, $withtemplate = 0): bool|string
    {
        ...
        switch ($item->getType()) {
            case Record::class:
                ...
                return self::createTabEntry(Record_Purpose::getTypeName($nb), $nb);
        }
    ...
    {
        $id = $record->fields['id'];
        if (!Purpose::canView() || !$record->can($id, READ)) {
            return false;
        }
        ...
        if ($canedit) {
            ...
            Purpose::dropdown([
                'addicon' => Purpose::canCreate(),
                'name' => 'plugin_gdprropa_purposes_id',
    ...
    public static function rawSearchOptionsToAdd(): array
    {
        ...
        $tab[] = [
            'id' => 'purpose',
            'name' => Purpose::getTypeName()
        ];

        $tab[] = [
            'id' => '251',
            'table' => Purpose::getTable(),
            'field' => 'name',
            'name' => __("Name"),
            'forcegroupby' => true,
            'massiveaction' => false,
